			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="p-30 mb-30 card-view">
						...
						<h3 class="mt-30 mb-5"><a href="#"><b>Цех по переработке овощей и фруктов</b></a></h3>
						<ul class="list-li-mr-10 color-lite-black">
							<li><i class="mr-5 font-12 ion-clock">10.07.2021</i></li>
						</ul>
						<p class="mt-30">Данный цех оборудован современным оборудованием для изготовления консервов, варенных и копченых колбас. Отделение для разделки мяса, стерилизатор для ножей, моечное отделение. Отдельно готовятся полуфабрикаты. И под рукой у технологов вся современная кухонная техника: мясорубка с подводом холода, чтобы не было разогрева фарша, фаршемешалка, камера для шоковой заморозки, промышленные холодильники и морозильники.</p>
						<p class="mtb-15"></p>
					</div>
