			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="p-30 mb-30 card-view">
						<img src="/styles/img/mikro.jpg" alt="">
						<h3 class="mt-30 mb-5"><a href="#"><b>Микробиологическая лаборатория</b></a></h3>
						<ul class="list-li-mr-10 color-lite-black">
							<li><i class="mr-5 font-12 ion-clock">10.07.2021</i></li>
						</ul>
						<p class="mt-30">

						Данная лаборатория предназначена для определения микробиологических показателей как сырья, так и готовой пищевой продукции. Цех оборудован современным необходимым оборудованием и инвентарем для проведения микробиологических показателей.
