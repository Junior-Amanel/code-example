            ...
            <form action="{{route('news.store')}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="annons" class="form-control" placeholder="Введите Аннонс Статьи" required>

                  <label for="exampleInputEmail1">Новость</label>
                  <input type="text" name="text" class="form-control"  placeholder="Введите  Статью" required>
